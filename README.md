...
* Fixed the error, that only the first of several holes in the file is drilled with the correct depth, whereas all following holes are only spot drilled. Now alle holed are drilled corretly with the given depth.
